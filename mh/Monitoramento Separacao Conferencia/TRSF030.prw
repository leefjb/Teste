...
±±³Funcao    ³ TRSF030  ³ Autor ³ Jeferson Dambros      ³ Data ³ Set/2014 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descricao ³ Conferencia pedido ( Browse )                              ³±±
...
User Function TRSF030()
	...
	Private cF030Cad	:= "Conferencia pedido (Browse) "
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Funcao    ³F030Confer³ Autor ³ Jeferson Dambros      ³ Data ³ Set/2014 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
...
Static Function F030Confer(aBrowse, cMvFluxo, nDigQtd)
	...
	For nDocDe := 1 To nDocAte
		...
		lConferido := u_TRSF031(	aConferir[nDocDe,1],;	// 1 Pedido
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Funcao    ³F030PvStat³ Autor ³ Jeferson Dambros      ³ Data ³ Abr/2015 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Funcao    ³F030Produt³ Autor ³ Jeferson Dambros      ³ Data ³ Set/2014 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
...
Static Function F030Produt(cMvFluxo)  
	...
	cQuery += " 								AND	A1_COD	 = SC5." + aF030MvCpo[1] 
	cQuery += " 								AND	A1_LOJA = SC5." + aF030MvCpo[2]
	...
	cQuery += "   	AND	SC5.C5_BLQ		 = ' '"	//-- Nao bloqueado
	cQuery += "  		AND	SC6.C6_QTDSEP  > 0"	 	//-- Separado
	cQuery += "  		AND	SC6.C6_QTDCONF = 0" 		//-- Nao conferido
	cQuery += "   	AND	SF4.F4_ESTOQUE = 'S'" 	//-- S = Controla estoque Sim 
	
	If cMvFluxo = "1"
		cQuery += "  AND	SC5.C5_PVSTAT  = '" + FATURADO + "'"
	ElseIf cMvFluxo = "2"
		cQuery += "  AND	SC5.C5_PVSTAT  IN ('"+ ENVIADO_CONFERENCIA +"', '"+ SEPARADO +"')"
		cQuery += "  AND	SC5.C5_NOTA	 = ' '" 	//-- Nao faturado
	EndIf
	...
	cQuery += " 		AND	SF4.F4_CODIGO = C6_TES"		
	...
	cQuery += "			' ' 			BOXSEP,"
	cQuery += "			L1_CLIENTE "	+ aF030MvCpo[1] +"," //-- Cliente entrega 	
	cQuery += "			L1_LOJA "  	+ aF030MvCpo[2] +"," //-- Loja cliente entrega
	...
	cQuery += "		AND	SL1.L1_PVSTAT IN ('"+ SEPARADO +"', '"+ ENVIADO_CONFERENCIA +"', '" + CONFERIDO + "', '" + FATURADO + "')"
	
	cQuery += "   	AND	SL2.L2_QTDCONF = 0" 	//-- Nao conferido
	cQuery += "   	AND	SL2.L2_QTDSEP	> 0" 	//-- Separado
		
	cQuery += " 		AND	SL2.L2_FILIAL = '" + xFilial("SL2") + "'"		 
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Funcao    ³F030OrdBro³ Autor ³ Jeferson Dambros      ³ Data ³ Set/2014 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Funcao    ³F030CriaSx³ Autor ³ Jeferson Dambros      ³ Data ³ Ago/2015 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
