...
±±User Func. ³ JMHR025  ºAutor ³                     º Data ³   14/06/16  º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Impressao de etiqueta com codigo de barras 2D              º±±
...
Static Function ImpEtqNF( aProd )
	...
	While ( nX < Len(aProd) )
		...
		// Cristiano Oliveira - Aqui é o LOTE, mas o cliente deseja que apareça o LABEL como SÉRIE - 08/03/2016
...
//		MsCbSay( nCol2 , nLin , PadR(OemToAnsi("Calibre: " + aEtq2[CALIBRE] + " Comprimento: " + aEtq2[COMPRIMENTO]),60)	, "N" , "0" , cTamFonte , , , , , .F. )
		...
		nLin  += 002.5
		MsCbSay( nCol1 , nLin , PadR("Série: " + aEtq1[LOTECTL] + "  Vencimento: " + aEtq1[VENCTOLOTE],50)	, "N" , "0" , cTamFonte , , , , , .F. )
		MsCbSay( nCol2 , nLin , PadR("Série: " + aEtq2[LOTECTL] + "  Vencimento: " + aEtq2[VENCTOLOTE],50)	, "N" , "0" , cTamFonte , , , , , .F. )
		...
		nLin  += 003
		MsCbSay( nCol1 , nLin , PadR("Armaz./Uso/Precauções do Produto:",50)	, "N" , "0" , cTamFonte , , , , , .F. )
		MsCbSay( nCol2 , nLin , PadR("Armaz./Uso/Precauções do Produto:",50)	, "N" , "0" , cTamFonte , , , , , .F. )
		...
		nLin  := 058
		MsCbSay( nCol1 + 02 , nLin , 'Série: '+aEtq1[LOTECTL]	, "N" , "0" , cTamFonte )
		MsCbSay( nCol1 + 27 , nLin , 'Série: '+aEtq1[LOTECTL]	, "N" , "0" , cTamFonte )
		MsCbSay( nCol2 + 02 , nLin , 'Série: '+aEtq2[LOTECTL]	, "N" , "0" , cTamFonte )
		MsCbSay( nCol2 + 27 , nLin , 'Série: '+aEtq2[LOTECTL]	, "N" , "0" , cTamFonte )
