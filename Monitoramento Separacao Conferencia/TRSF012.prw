...
User Function TRSF012()
	...
	If Empty(cMvFluxo) .Or. !(cMvFluxo $ "12") .and. (cEmpAnt <> "06" .and. cEmpAnt <> "01")
	...
	Else
		...
		If cMvFluxo = "1"  .and. (cEmpAnt <> "06" .and. cEmpAnt <> "01")
		...
		ElseIf cMvFluxo = "2"  .and. (cEmpAnt <> "06" .and. cEmpAnt <> "01")
